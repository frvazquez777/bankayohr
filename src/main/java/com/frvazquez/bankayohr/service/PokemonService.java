...
public class PokemonService {
	...
	public Pokemon getPokemonString(String pokemon) {
		LOG.info("----------------------------------------------------------------------------");
	...
	public Pokemon getPokemon(String pokemon) {
		...
		LOG.info("Peticion al servicio web...");
		Pokemon response = new Pokemon();
		Mono<ResponseVO> resultado = client.getApiRest(Constants.API + pokemon, ResponseVO.class);
	
		response = mapper.getResponseToPokemon(resultado.block());
